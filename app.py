from hateSpeechClassifier.pipeline.train_pipeline import TrainPipeline
...
from hateSpeechClassifier.pipeline.prediction_pipeline import PredictionPipeline
